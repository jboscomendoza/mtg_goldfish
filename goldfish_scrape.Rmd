...
Hora del análisis del valor monetario de la caja.
...
Usamos `density()` para obtener la función de densidad de estos valores.
```{r}
...
En este caso es más o menos un volado.
